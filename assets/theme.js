...
$(window).onload = function(){
  if(window.location.href.indexOf("pc001.htm") > -1) {
       window.location.href="https://shop.africanancestry.com/collections/ancestry-test-kits/products/patriclan-test-kit";
    }
  
  	if(window.location.href.indexOf("mc001.htm") > -1) {
       window.location.href="https://shop.africanancestry.com/collections/ancestry-test-kits/products/matriclan-test-kit";
    }
  
  	if(window.location.href.indexOf("1817.htm") > -1) {
       window.location.href="https://shop.africanancestry.com/collections/ancestry-test-kits";
    }
  
  	if(window.location.href.indexOf("1818.htm") > -1) {
       window.location.href="https://shop.africanancestry.com/collections/know-your-roots-items";
    }
  
  	if(window.location.href.indexOf("1821.htm") > -1) {
       window.location.href="https://shop.africanancestry.com/collections/ancestry-gifts";
    }
}
...
$(document).ready(function() {
  ...
  var sections = new theme.Sections();
    ...
    //CUSTOM AFA JQUERY
    //Place Footer Custom HTML inside shopify footer
    $(".shopify-footer-custom").prependTo($(".site-footer .wrapper"));
    
    $(".site-header .logo__image-wrapper a").attr("href","http://africanancestry.com/");
  
  	var afaFooterHtml = '<footer class="grid shopify-footer-custom">'+

                            '<div class="footer-top-spacer"></div>'+

                            '<div class="grid__item footer-container">'+

                              '<div class="grid">'+

                                '<div class="grid__item large--one-third medium--one-whole text-left">'+
                                  '<div class="footer-mailing-list">'+
                                    '<a href="http://africanancestry.com#newsletterModal" id="newsletterLink"><img src="https://cdn.shopify.com/s/files/1/2138/0103/files/newsletterbutton_300x300.png?v=1508267502"></a>'+
                                  '</div>'+
                                '</div>'+

                                '<div class="grid__item large--one-third medium--one-whole text-center">'+
                                  '<div class="footer-links">'+
                                    '<a href="http://africanancestry.com/terms/" data-toggle="modal">Terms &amp; Conditions</a>&nbsp;'+
                                    '<a href="http://africanancestry.com/privacy/" data-toggle="modal">Privacy Policy</a>&nbsp;'+
                                    '<a href="http://africanancestry.com/contact/">Contact</a>'+
                                    '<br>'+
                                    '<span class="footer-sm-txt">'+
                                      '©2017 African Ancestry, Inc. All rights reserved'+
                                    '</span>'+
                                  '</div>'+
                                '</div>'+
                                ...
                                '<div class="grid__item large--one-third medium--one-whole text-right">'+
                                  '<div class="footer-contact">'+
                                    '<a href="https://www.facebook.com/africanancestry" target="_blank"><img src="https://cdn.shopify.com/s/files/1/2138/0103/files/fb_grey_2048x.jpg?v=1508267515"></a>&nbsp;'+
                                    '<a href="https://twitter.com/africanancestry" target="_blank"><img src="https://cdn.shopify.com/s/files/1/2138/0103/files/tw_grey_2048x.jpg?v=1508267520"></a>&nbsp;'+
                                    '<a href="https://instagram.com/africanancestry/" target="_blank"><img src="https://cdn.shopify.com/s/files/1/2138/0103/files/ig_grey_2048x.jpg?v=1508267526"></a>&nbsp;'+
                                    '<a href="http://www.youtube.com/user/AfricanAncestry" target="_blank"><img src="https://cdn.shopify.com/s/files/1/2138/0103/files/yt_grey_2048x.jpg?v=1508267531"></a>'+

                                    '<br>'+
                                    'Call OR CLICK to place an order'+
                                    '<br>'+

                                    '<div class="hidden-xs">'+
                                      '<a href="http://shop.africanancestry.com">'+
                                        '<span class="footer-phone"><img class="footer-phone-icon" src="https://cdn.shopify.com/s/files/1/2138/0103/files/telephone_icon_grey_2048x.png?v=1508267509"><span> <span id="gc-number-0" class="gc-cs-link" title="Call with Google Voice">202​-723​-0900</span></span></span>'+
                                      '</a>'+
                                    '</div>'+
    ...
    if(!$("body").hasClass("template-index")){
      $(afaFooterHtml).prependTo($(".site-footer .wrapper"));
    }
  
  	$(".breadcrumb a:first-child").html("Shopping Home");
  	
  	//******
  	// Date Range Check for Holiday Promo
    ...
    var todaysDate = (month) + "/" + (day) + "/" + now.getFullYear();

    if(dateCheck("12/01/2017","12/03/2017",todaysDate)){
       $(".slide-link").html("<img class='lazyautosizes lazyloaded' src='https://cdn.shopify.com/s/files/1/2138/0103/files/AFA_Shopify-Cart_Header-Offer-1_2048x.png?v=1512079685' />");   
    }
  	else if(dateCheck("12/08/2017","12/10/2017",todaysDate)){
       $(".slide-link").html("<img class='lazyautosizes lazyloaded' src='https://cdn.shopify.com/s/files/1/2138/0103/files/AFA_Shopify-Cart_Header-Offer-2_2048x.png?v=1512079679' />");   
    }
  	else if(dateCheck("12/15/2017","12/17/2017",todaysDate)){
       $(".slide-link").html("<img class='lazyautosizes lazyloaded' src='https://cdn.shopify.com/s/files/1/2138/0103/files/AFA_Shopify-Cart_Header-Offer-3_2048x.png?v=1512079672' />");   
    }
  	else if(dateCheck("12/22/2017","12/24/2017",todaysDate)){
       $(".slide-link").html("<img class='lazyautosizes lazyloaded' src='https://cdn.shopify.com/s/files/1/2138/0103/files/AFA_Shopify-Cart_Header-Offer-4_2048x.png?v=1512079651' />");  
    }
  	else if(dateCheck("12/29/2017","12/31/2017",todaysDate)){
       $(".slide-link").html("<img class='lazyautosizes lazyloaded' src='https://cdn.shopify.com/s/files/1/2138/0103/files/AFA_Shopify-Cart_Header-Offer-5_preview_2048x.png?v=1513292526' />");  
    }
  	
  	// End Date Range Check for Holiday Promo
    //******
